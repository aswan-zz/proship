...
class AvailabilitiesControllerTest < ActionController::TestCase
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post :create, availability: { availability_type_id: @availability.availability_type_id, comment: @availability.comment, end_date: @availability.end_date, start_date: @availability.start_date }
    end
  ...
  test "should update availability" do
    patch :update, id: @availability, availability: { availability_type_id: @availability.availability_type_id, comment: @availability.comment, end_date: @availability.end_date, start_date: @availability.start_date }
    assert_redirected_to availability_path(assigns(:availability))
  end
