...
class MeetingTypesControllerTest < ActionController::TestCase
  ...
  test "should create meeting_type" do
    assert_difference('MeetingType.count') do
      post :create, meeting_type: { default_color: @meeting_type.default_color, icon: @meeting_type.icon, name: @meeting_type.name }
    end
  ...
  test "should update meeting_type" do
    patch :update, id: @meeting_type, meeting_type: { default_color: @meeting_type.default_color, icon: @meeting_type.icon, name: @meeting_type.name }
    assert_redirected_to meeting_type_path(assigns(:meeting_type))
  end
