...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { member_id: @reminder.member_id, note: @reminder.note, reminder_type_id: @reminder.reminder_type_id, schedule: @reminder.schedule }
    end
  ...
  test "should update reminder" do
    patch :update, id: @reminder, reminder: { member_id: @reminder.member_id, note: @reminder.note, reminder_type_id: @reminder.reminder_type_id, schedule: @reminder.schedule }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
